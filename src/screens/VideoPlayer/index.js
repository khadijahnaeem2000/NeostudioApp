...
class VideoPlayer extends Component {
    ...
    render() {
        ...
        return (
            <View style={[styles.container, this.styles.containerStyle]}>
                <Vimeo
                    videoId={vimeoLink.match(/(\d+)$/)[0]}
                    autoplay={false}
                    loop={false}
                    onCustomMenuSelection={() => { }}
                    allowsLinkPreview={false}
                    onReady={() => console.log('Video is ready')}
                    onPlay={() => console.log('Video is played')}
                    onPause={() => console.log('Video is paused')}
                    onEnded={() => console.log('Video is ended')}
                    onTimeUpdate={() => console.log('Video time updated')}
                    onProgress={() => console.log('Video is ready')}
